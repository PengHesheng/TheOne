package com.example.a14512.theone.model.dao;
...
import static com.example.a14512.theone.ConfigKt.STATUS_VERIFY_NONE;
import static com.example.a14512.theone.ConfigKt.STATUS_VERIFY_READED;
    ...
    public void updateBatchStatus(){
        ...
        if(infos!=null && infos.size()>0){
            ...
            for (int i = 0; i < size; i++) {
                ...
                msg.setStatus(STATUS_VERIFY_READED);
                all.add(msg);
            }
